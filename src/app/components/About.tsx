...
const timelineEvents = [
  {
    ...
    description:
      "In addition to majoring in chemistry and minoring in biology, I studied " +
      "poverty economics and looked at how pricing, education, and " +
      "policy choices affected people in Macon. I became focused on a practical " +
      "question: which interventions actually hold up at scale?",
    image:
  ...
  },
  {
    ...
    description:
      "Secured grant funding and implemented drip irrigation at an agricultural " +
      "technical school previously dependent on rain-fed crops, restoring " +
      "reliable yields and making on-campus food production viable under local " +
      "constraints.",
    image:
  ...
  },
  {
    ...
    description:
      "Built Excel- and Bloomberg API-based monitoring systems that supported FX " +
      "and bond market expansion across Africa and the Middle East. Developed " +
      "tools regional teams used to track sovereign bond activity, including " +
      "long-term monitoring of the Ghanaian bond market, in politically " +
      "sensitive and tightly regulated markets.",
    image:
  ...
  },
  {
    ...
    description:
      "Completed a two-year Product Design & Manufacturing certificate while " +
      "working full-time. Built hands-on prototyping discipline across CAD and " +
      "iterative physical builds, shifting from analyzing systems to making and " +
      "shipping tangible products. For my capstone, I studied embodied AI and " +
      "explored how physical interfaces can give users more direct control over " +
      "software systems.",
    image:
        ...
        <div className="max-w-5xl mx-auto md:mx-0">
          ...
          <div className="mb-8">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-gray-300/90">
              ...
              real-world friction. Whether the constraint was water, regulation,
              data integrity, or computational scale, I build for reliability
              under constraint.
            </p>
          </div>
