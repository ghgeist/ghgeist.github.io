...
- See `asset-management.md` for asset organization and references.
...
- See `asset-management.md` for how to reference static assets.
...
- **Naming conventions**: See `file-naming.md` for component and file naming patterns.
- **Verification commands**: See `iteration-workflow.md` for build, test, and lint commands.
- **Asset references**: See `asset-management.md` for how to reference `public/` assets.
